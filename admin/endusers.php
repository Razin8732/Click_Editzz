...
<body>
    ...
    <?php
    $query = "SELECT * FROM enduser ORDER BY id ASC";
    $result = mysqli_query($conn, $query);
    ?>
    <div class="container">
        <div class="table-responsive">
            <h3 align="center">Enduser Details</h3><br />
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Add new enduser</h4>
...
$(document).ready(function() {
    ...
    $('#editable_table').Tabledit({
        url: 'instructor-action.php?from=enduser',
        columns: {
            identifier: [0, "id"],
            editable: [
                [1, 'name'],
