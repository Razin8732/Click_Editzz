<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="/RAZIN/web2/instructor/index.php">Click_Editz (Instructor)</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="/RAZIN/web2/instructor/index.php">Home</a>
            </li>
            <li class="nav-item">
        ...
        <a href="/RAZIN/web2/instructor/profile.php" class="btn btn-secondary text-light btn-sm mr-2 float-right">
            Profile
        </a>
         <a href="/RAZIN/web2/instructor/upload.php" class="btn btn-secondary text-light btn-sm mr-2 float-right">
            Upload course
        </a>
        <a href="/RAZIN/web2/instructor/logout.php" class="btn btn-secondary text-light btn-sm mr-2 float-right">
            Logout
        </a>
        <?php
        } else{ ?>
    ...
    <form method="post" action="/RAZIN/web2/instructor/login.php">
    ...
    <form method="post" action="/RAZIN/web2/instructor/signup.php">
